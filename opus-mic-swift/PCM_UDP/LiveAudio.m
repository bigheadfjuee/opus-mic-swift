...
static OSStatus recordingCallback(void *inRefCon, 
     ...
     */
    LiveAudio *audioProcessor = (__bridge LiveAudio*) inRefCon;
  ...
  [audioProcessor hasError:status andFile:__FILE__ andLine:__LINE__];
    ...
    [audioProcessor processBuffer:&bufferList];
	  [audioProcessor sendBuffer:&bufferList];
    // clean up the buffer
...
static OSStatus playbackCallback(void *inRefCon, 
	...
	for (int i=0; i < ioData->mNumberBuffers; i++) { 
        ...
        // find minimum size
		UInt32 size = min(buffer.mDataByteSize, [audioProcessor mAudioBuffer].mDataByteSize);
        
        // copy buffer to audio buffer which gets played after function return
		memcpy(buffer.mData, [audioProcessor mAudioBuffer].mData, size);
...
{    
	...
	audioFormat.mSampleRate			= LIVE_SAMPLE_RATE;
    ...
    */
	...
	mAudioBuffer.mDataByteSize = 512 * 2;
	mAudioBuffer.mData = malloc( 512 * 2 );
